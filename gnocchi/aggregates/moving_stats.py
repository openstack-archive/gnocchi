...
class MovingAverage(aggregates.CustomAggregator):
    ...
    def aggregate_data(data, func, window, min_grain, center=False,
        ...
        :param window: range of data to use (in seconds) in each aggregation.
    ...
    def compute(self, storage_obj, metric_id, start, stop, window,
                center=False):
        ...
        :param window: the size over which to aggregate the retrieved data
