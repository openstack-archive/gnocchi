...
dispatcher_opts = [
    cfg.StrOpt('user_id',
               default=None,
               help='Gnocchi user id, used to filter out samples '
...
class GnocchiDispatcher(dispatcher.Base):
    def __init__(self, conf):
        ...
        self.gnocchi_user_id = conf.dispatcher_gnocchi.user_id
    ...
    def record_metering_data(self, data):
        ...
        data = [s for s in data
                if (s['project_id'] and s['user_id']
                    and (not self.gnocchi_user_id or
                         s['user_id'] != self.gnocchi_user_id))]
