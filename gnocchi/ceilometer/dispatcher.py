...
dispatcher_opts = [
    cfg.StrOpt('project_id',
               default="<uuid>",
               help='Gnocchi project id, used to filter out samples '
               'generated by Gnocchi'),
    cfg.StrOpt('url',
...
class GnocchiDispatcher(dispatcher.Base):
    def __init__(self, conf):
        ...
        self.gnocchi_project_id = conf.dispatcher_gnocchi.project_id
    ...
    def record_metering_data(self, data):
        ...
        # we also skip sample generated by gnocchi itself
        data = [s for s in data
                if (s['project_id'] and s['user_id']
                    and (not self.gnocchi_project_id or
                         s['project_id'] != self.gnocchi_project_id))]
