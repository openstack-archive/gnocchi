...
class GnocchiDispatcher(dispatcher.Base):
    ...
    def _create_or_update_resource(self, ext, sample):
        ...
        try:
            ...
            LOG.exception("Fail to get %s metadata of resource %s of from %s" %
                          (resource_type, resource_id, sample))
            return
    ...
    def _send_datapoint(self, ext, sample, create_entity=True):
        ...
        if r.status_code == 404:
            ...
            if create_entity:
                ...
                if r.status_code / 100 != 2:
                    LOG.error(_("Fail to create entity %(entity_name)s of "
                    ...
                    # retry one time to create the datapoint
                    self._send_datapoint(ext, sample, create_entity=False)
