...
from ceilometer.api.controllers import base as api
import wsme
from wsme import types as wtypes


class AlarmGnocchiThresholdRule(api.AlarmRule):
    ...
    comparison_operator = api.AdvEnum('comparison_operator', str,
                                      'lt', 'le', 'eq', 'ne', 'ge', 'gt',
                                      default='eq')
    ...
    statistic = api.AdvEnum('statistic', str, 'max', 'min', 'mean', 'sum',
                            'count', default='mean')
