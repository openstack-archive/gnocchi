...
class AggregatedMetricController(rest.RestController):
    ...
    def get_measures(self, start=None, stop=None, aggregation='mean',
        ...
        self.get_cross_metric_measures(self.metrics_id, start, stop,
                                       aggregation, needed_overlap)

    @staticmethod
    def get_cross_metric_measures(metric_ids, start=None, stop=None,
                                  aggregation='mean', needed_overlap=None):
...
class V1Controller(rest.RestController):
    ...
    _custom_actions = {
        'aggregated_metric_measures': ['POST'],
    }

    @pecan.expose('json')
    def post_aggregated_metric_measures(self, metric=None, start=None,
                                        stop=None, aggregation='mean',
                                        needed_overlap=None):
        AggregatedMetricController.get_cross_metric_measures(metric,
                                                             start, stop,
                                                             aggregation,
                                                             needed_overlap)
