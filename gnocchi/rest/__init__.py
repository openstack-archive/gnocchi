...
def get_user_and_project():
    ...
    if user_id:
        user_id = six.text_type(str(user_id))
    if project_id:
        project_id = six.text_type(str(project_id))
...
def ResourceSchema(schema):
    base_schema = {
        ...
        voluptuous.Optional('user_id'): six.text_type,
        voluptuous.Optional('project_id'): six.text_type,
