...
class ResourceTest(RestTest):
    ...
    def test_post_resource(self):
        ...
        self.assertEqual("http://localhost/v1/resource/"
                         ...
                         result.headers['Location'])
        self.assertIsNone(resource['lifetime_to'])
        self.assertEqual(resource['lifetime_from'],
    ...
    def test_get_resource(self):
        ...
        self.assertIsNone(result['lifetime_to'])
        self.assertEqual(result['lifetime_from'],
                         "2014-01-01T10:23:00.000000Z")
    ...
    def test_patch_resource_metrics(self):
        ...
        self.assertTrue(uuid.UUID(result['metrics']['foo']))
        self.assertIsNone(result['lifetime_to'])
        self.assertIsNone(r['lifetime_to'])
        self.assertEqual(result['lifetime_from'],
                         "2014-01-02T06:48:00.000000Z")
        self.assertEqual(r['lifetime_from'], "2014-01-01T10:23:00.000000Z")
    ...
    def test_patch_resource_attributes(self):
        ...
        self.assertEqual(h['lifetime_to'],
                         "2014-01-02T06:48:00.000000Z")
