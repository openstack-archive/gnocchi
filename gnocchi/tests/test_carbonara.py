...
class TestAggregatedTimeSerie(base.BaseTestCase):
    ...
    def test_aggregated_different_archive_overlap(self):
        ...
        self.assertEqual([
            (datetime.datetime.strptime(
                '2014-01-01 12:01:00',
                '%Y-%m-%d %H:%M:%S'), 60.0, 3.0),
            (datetime.datetime.strptime(
                '2014-01-01 12:02:00',
                '%Y-%m-%d %H:%M:%S'), 60.0, 3.0),
            (datetime.datetime.strptime(
                '2014-01-01 12:03:00',
                '%Y-%m-%d %H:%M:%S'), 60.0, 4.0),
            (datetime.datetime.strptime(
                '2014-01-01 12:04:00',
                '%Y-%m-%d %H:%M:%S'), 60.0, 4.0),
            (datetime.datetime.strptime(
            ...
            (datetime.datetime.strptime(
                '2014-01-01 12:06:00',
                '%Y-%m-%d %H:%M:%S'), 60.0, 5.0),
            (datetime.datetime.strptime(
                '2014-01-01 12:07:00',
                '%Y-%m-%d %H:%M:%S'), 60.0, 10.0),
            (datetime.datetime.strptime(
                '2014-01-01 12:09:00',
                '%Y-%m-%d %H:%M:%S'), 60.0, 2.0),
        ], output)
    ...
    def test_aggregated_different_archive_overlap_edge_missing1(self):
        ...
        self.assertEqual([
            (datetime.datetime.strptime(
                '2014-01-01 12:03:00',
                '%Y-%m-%d %H:%M:%S'), 60.0, 33.0),
            (datetime.datetime.strptime(
                '2014-01-01 12:04:00',
                '%Y-%m-%d %H:%M:%S'), 60.0, 5.0),
            (datetime.datetime.strptime(
                '2014-01-01 12:05:00',
                '%Y-%m-%d %H:%M:%S'), 60.0, 18.0),
            (datetime.datetime.strptime(
                '2014-01-01 12:06:00',
                '%Y-%m-%d %H:%M:%S'), 60.0, 19.0),
        ], output)
