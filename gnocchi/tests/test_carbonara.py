...
class TestTimeSerieArchive(base.BaseTestCase):
    ...
    def test_fetch(self):
        ...
        self.assertEqual([
            ...
            (datetime.datetime(2014, 1, 1, 12, 05), 300.0, 6.0),
            ...
            (datetime.datetime(2014, 1, 1, 12, 01), 60.0, 5.5),
            (datetime.datetime(2014, 1, 1, 12, 02), 60.0, 8.0),
            (datetime.datetime(2014, 1, 1, 12, 03), 60.0, 3.0),
            (datetime.datetime(2014, 1, 1, 12, 04), 60.0, 7.0),
            (datetime.datetime(2014, 1, 1, 12, 05), 60.0, 7.0),
            (datetime.datetime(2014, 1, 1, 12, 06), 60.0, 3.0)
        ], tsc.fetch())
    ...
    def test_aggregated_nominal(self):
        ...
        self.assertEqual([
            ...
            (datetime.datetime(2014, 1, 1, 12, 00), 300.0, 6.0),
            (datetime.datetime(2014, 1, 1, 12, 05), 300.0, 5.1666666666666661),
            ...
            (datetime.datetime(2014, 1, 1, 11, 58), 60.0, 5.0),
            (datetime.datetime(2014, 1, 1, 12, 01), 60.0, 6.0),
            (datetime.datetime(2014, 1, 1, 12, 02), 60.0, 7.0),
            (datetime.datetime(2014, 1, 1, 12, 03), 60.0, 4.5),
            (datetime.datetime(2014, 1, 1, 12, 04), 60.0, 5.5),
            (datetime.datetime(2014, 1, 1, 12, 05), 60.0, 6.75),
            (datetime.datetime(2014, 1, 1, 12, 06), 60.0, 2.0),
        ], output)
