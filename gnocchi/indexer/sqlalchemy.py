...
class ResourceEntity(Base, GnocchiBase):
    ...
    __table_args__ = (
        ...
        sqlalchemy.Index('ix_resourceentity_name', 'name'),
        sqlalchemy.Index('ix_resourceentity_entity_id', 'entity_id'),
        sqlalchemy.Index('ix_resourceentity_resource_id', 'resource_id'),
    )
