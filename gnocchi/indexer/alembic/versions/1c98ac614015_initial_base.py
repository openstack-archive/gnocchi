...
def upgrade():
    ...
    sa.Column('type', sa.Enum('metric', 'generic', 'instance', 'swift_account', 'volume', 'ceph_account', 'network', 'identity', 'ipmi', 'stack', 'image', name='resource_type_enum'), nullable=False),
    ...
    sa.Column('id', sqlalchemy_utils.types.uuid.UUIDType(binary=False), nullable=False),
    sa.ForeignKeyConstraint(['id'], ['resource.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id'),
    mysql_charset='utf8',
    mysql_engine='InnoDB'
    )
    ...
    sa.ForeignKeyConstraint(['archive_policy_name'], ['archive_policy.name'], ondelete='RESTRICT'),
    sa.PrimaryKeyConstraint('name'),
    mysql_charset='utf8',
    mysql_engine='InnoDB'
    )
    ...
    sa.Column('id', sqlalchemy_utils.types.uuid.UUIDType(binary=False), nullable=True),
    ...
    sa.Column('revision', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['revision'], ['resource_history.revision'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('revision'),
    mysql_charset='utf8',
    mysql_engine='InnoDB'
    )
