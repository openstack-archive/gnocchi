...
class Resource(object):
    def __init__(self, id, type, created_by_user_id, created_by_project_id,
                 user_id=None, project_id=None, started_at=None, ended_at=None,
                 revision=None, revision_start=None, revision_end=None, metrics=None,
                 **kwargs):
        self.id = id
        self.type = type
