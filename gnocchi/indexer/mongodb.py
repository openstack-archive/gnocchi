...
class MongodbIndexer(indexer.IndexerDriver):
                ...
                if uuid.UUID('{%s}' % k) in uuids:
                    res.append(
                        storage.Metric(
                            ...
                            v['created_by_project_id'], name=v['name'],
    ...
    def create_resource(self, resource_type, id,
        ...
        r = {'_id': id,
             ...
             'started_at': utils.to_timestamp(started_at) or utils.utcnow(),
        ...
        return indexer.Resource(r['id'], r['type'], r['created_by_user_id'],
                                ...
                                started_at=utils.to_timestamp(r.get('started_at')),
    ...
    def get_resource(self, resource_type, resource_id, with_metrics=False):
        ...
        if r:
            return indexer.Resource(
                r['id'], r['type'], r['created_by_user_id'],
    ...
    def _resources_list(self, found_resources):
        return list(
            indexer.Resource(
                ...
                r.pop('created_by_project_id'),
                started_at=timeutils.normalize_time(r.pop('started_at')),
                metrics=[storage.Metric(
                    uuid.UUID(k),
                    self._archive_policy_model(
    ...
    def list_resources(self, resource_type='generic',
        ...
        res = self._resources_list(self.db.resource.find(sum_query))
