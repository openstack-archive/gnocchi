...
class RedisStorage(_carbonara.CarbonaraBasedStorage):
    ...
    def _create_metric(self, metric):
        ...
        ret = self._client.set(path, "created", nx=True)
        if ret is None:
    ...
    def _list_split_keys_for_metric(self, metric, aggregation, granularity,
                                    version=None):
        if self._client.get(self._build_metric_dir(metric)) is None:
            raise storage.MetricDoesNotExist(metric)
    ...
    def _delete_metric_measures(self, metric, timestamp_key, aggregation,
        ...
        self._client.delete(self._build_metric_path_for_split(
    ...
    def _delete_metric(self, metric):
        self._client.delete(self._build_metric_dir(metric))
