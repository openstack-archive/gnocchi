...
class InfluxDBStorage(storage.StorageDriver):
    ...
    def __init__(self, conf):
        ...
        try:
            ...
            # NOTE(sorrison) I don't like this, maybe it should be removed
            #                completely and users need to run gnocchi-upgrade
            #                on new installations?
            index = indexer.get_driver(conf._conf)
            self.setup_archive_policies(index)
