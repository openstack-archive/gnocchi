...
from gnocchi.storage.common import file
from gnocchi.storage.incoming import file as incoming_file
...
class FileStorage(file.FileStorageBase,
                  _carbonara.CarbonaraBasedStorage):
    WRITE_FULL = True

    def __init__(self, conf):
        super(FileStorage, self).__init__(conf)
        self.incoming = incoming_file.FileStorage(conf)
