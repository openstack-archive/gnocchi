...
from gnocchi.storage.incoming import ceph as incoming_ceph
...
class CephStorage(_carbonara.CarbonaraBasedStorage):
    ...
    def __init__(self, conf):
        ...
        # TODO(sileht): Remove this when all drivers are splitted
        self.incoming = incoming_ceph.CephStorage(conf)
