...
OPTIONS = [
    ...
    cfg.IntOpt('kairos_port',
               default='8080',
               help='KairosDB port.'),
    cfg.FloatOpt('kairosdb_write_delay',
                 default='0.02',
                 help='Write delay in seconds'),
    ]
...
class KairosStorage(storage.StorageDriver):
    ...
    def add_measures(self, metric, measures):
        ...
        self._write(data)
        # KairosDB has a write delay of 1000 milliseconds by default.
        # In case of changing this value in the KairosDB configuration file,
        # 'write_delay' should be set to the corresponding value in seconds.
