...
class BoundTimeSerie(TimeSerie):
    def __init__(self, timestamps=None, values=None,
        ...
        datapoints associated with an entity.
...
class AggregatedTimeSerie(TimeSerie):
    ...
    def __init__(self, timestamps=None, values=None,
        ...
        Used to represent the downsampled timeseries for a single
        granularity/aggregation-function pair supported by an entity.
...
class TimeSerieArchive(object):
    ...
    def __init__(self, full_res_timeserie, agg_timeseries):
        ...
        granularities supported an entity (for a particular aggregation
        function).
