...
gnocchi_endpoint=$(keystone endpoint-get --service metric | grep ' metric.publicURL ' | get_field 4)
die_if_not_set $LINENO gnocchi_url "Keystone fail to get gnocchi endpoint"
