...
function configure_gnocchi {
    ...
    if is_service_enabled key; then
        if is_service_enabled gnocchi-grafana; then
            ...
            # iniset $GNOCCHI_CONF cors allow_methods GET,POST,PUT,DELETE,OPTIONS,HEAD
            ...
            # iniset $GNOCCHI_CONF cors expose_headers Content-Type,Cache-Control,Content-Language,Expires,Last-Modified,Pragma
        else
