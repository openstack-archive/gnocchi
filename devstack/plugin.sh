...
function configure_gnocchi {
    ...
    if is_service_enabled key; then
        if is_service_enabled gnocchi-grafana; then
            iniset $GNOCCHI_PASTE_CONF composite:main / cors+gnocchi
            iniset $GNOCCHI_PASTE_CONF composite:main /v1 cors+gnocchi+auth
            ...
            iniset $GNOCCHI_PASTE_CONF composite:main / gnocchi
            iniset $GNOCCHI_PASTE_CONF composite:main /v1 gnocchi+auth
        fi
    else
        iniset $GNOCCHI_PASTE_CONF composite:main / gnocchi
