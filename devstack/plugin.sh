...
function install_gnocchi {
    ...
    sudo -H pip install keystonemiddleware==2.3.0 requests==2.7.0 WebOb==1.4.1 oslo.middleware==2.8.0 oslo.policy==0.11.0 oslo.serialization==1.9.0 oslo.service==0.9.0 oslo.utils==2.5.0 oslosphinx==3.2.0 oslotest==1.11.0
}
