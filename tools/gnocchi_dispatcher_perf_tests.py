...
# under the License.
#
# ceilometer.tools.make_test_data file was used as a base for this module
...
def main():
    ...
    parser.add_argument(
        ...
        default=31,
        type=int,
        help=('The number of days to go back in time '
              '(to generate realistic timestamps).'),
    )
    parser.add_argument(
        '--end',
        default=2,
        type=int,
        help=('The number of days to go further in time '
              '(to generate realistic timestamps).'),
    )
    parser.add_argument(
        '--type',
        ...
        default='gauge',
        help='Meter type to be sent.',
    )
    parser.add_argument(
        '--unit',
        default='instance',
        help='Meter unit to be sent.',
    )
    parser.add_argument(
        '--random_min',
        help=('Minimum value of random to be added as a correction '
              'to the given default meter value (volume).'),
        type=int,
        default=0,
    )
    parser.add_argument(
        '--random_max',
        help=('Maximum value of random to be added as a correction'
              'to the given default meter value (volume).'),
        type=int,
        default=0,
    )
    ...
    parser.add_argument(
        '--resource_count',
        help='Number of resources to generate samples for.',
        type=int,
        default=20
    )
    parser.add_argument(
        '--counter',
        default='instance',
        help='The counter (meter) to use.',
    )
    parser.add_argument(
        '--volume',
        help='The default value to be attached to the counter (meter).',
        type=int,
        default=1,
    )
    parser.add_argument(
        '--log-file',
        dest='log_file',
        help='File to write timing logs to.',
    ...
    parser.add_argument(
        '--project-id',
        help='Project id on behalf of which samples will be sent.',
        required=True,
    )
    parser.add_argument(
        '--user-id',
        help='User id of on behalf of whom samples will be sent.',
        required=True,
    )
