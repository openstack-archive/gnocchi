...
python binding to librados written with Cython, while Ceph currently (~10.0.X)
provides a binding written with ctypes. This library should replace the legacy
rados.py in Ceph.
