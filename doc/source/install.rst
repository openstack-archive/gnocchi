...
Gnocchi leverages omap and aio API of librados, but this is available in python binding
only since python-rados >= 12.0.0. To handle this, Gnocchi uses 'cradox' python
