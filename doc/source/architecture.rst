...
.. note::
   ...
   do in favour of more efficient write support. Therefore each point is always
   9B in Ceph where as the Swift and File backends may have a smaller storage
   footprint but higher I/O requirements.
